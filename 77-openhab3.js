/*
  ...
  https://github.com/pdmangel/node-red-contrib-openhab3
...
module.exports = function ( RED )
{
	...
	*/
	...
	RED.nodes.registerType( "openhab3-controller", OpenHABControllerNode );

	// start a web service for enabling the node configuration ui to query for available openHAB items

	RED.httpNode.get( "/openhab3/items", function ( req, res, next )
	{
	...
	/**
	* ====== openhab3-in ========================
	* Handles incoming openhab3 events, injecting
	...
	*/
	...
	//
	RED.nodes.registerType( "openhab3-in", OpenHABIn );


	/**
	* ====== openhab3-monitor ===================
	* Monitors connection status and errors of
	* the associated openhab3-controller
	* ===========================================
	*/
	...
	//
	RED.nodes.registerType( "openhab3-monitor", OpenHABMonitor );
	...
	*/
	...
	//
	RED.nodes.registerType( "openhab3-out", OpenHABOut );
	...
	*/
	...
	//
	RED.nodes.registerType( "openhab3-get", OpenHABGet );
	...
	*/
	...
	//
	RED.nodes.registerType( "openhab3-events", OpenHABEvents );
}
